...
class CommandExecutorFactory:
    ...
    def __init__(self, subscription_plan_service, output_printer, active_subscription_plan_service):
        ...
        self.command_mapping = {
            ...
            AddSubscription.COMMAND_NAME: AddSubscription(subscription_plan_service, output_printer, active_subscription_plan_service),
            PrintRenewalDetails.COMMAND_NAME: PrintRenewalDetails(subscription_plan_service, output_printer, active_subscription_plan_service)}
